...
namespace Domain.Constants
{
	public static class TelegramTextConstants
	{
		...
		public const string SuccessNameUpdate = $"{CheckMarkInBlockEmj} Имя успешно изменено!";
		public const string SuccessSNameUpdate = $"{CheckMarkInBlockEmj} Фамилия успешно изменена!";
		public const string SuccessPatronymicUpdate = $"{CheckMarkInBlockEmj} Отчество успешно изменено!";
		public const string SuccessPhoneUpdate = $"{CheckMarkInBlockEmj} Номер телефона успешно изменен!";
		...
		public const string ErrorAddUserEvent = $"{NegativeRedEmj}Мероприятие не добавлено! Возможно мероприятие с данным названием сущестует, либо осуществлен неверный ввод.";
		...
		public const string ErrorAddAdminEvent2 = $"{AlertEmj} Возникла ошибка при добавлении мероприятия. Пожалуйста, проверьте правильность ввода мероприятия, возможно такое мероприятие уже существует или дата указана неверно!";
		...
		public const string ErrorChangeAdminEvent2 = $"{AlertEmj} Возникла ошибка при изменении мероприятия. Пожалуйста, проверьте правильность ввода мероприятия, возможно мероприятие с таким названием уже существует!.";
